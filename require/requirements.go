...
//
//    require.Len(t, 3, mySlice, "The size of slice is not 3")
...
func Contains(t TestingT, contains, s interface{}, msgAndArgs ...interface{}) {
...
func NotContains(t TestingT, contains, s interface{}, msgAndArgs ...interface{}) {
...
//
//   actualObj, err := SomeFunction()
//   require.Error(t, "An error was expected" err,)
//   require.Equal(t, expectedError err,)
//   }
func EqualError(t TestingT, errString string, theError error, msgAndArgs ...interface{}) {
	if !assert.EqualError(t, errString, theError, msgAndArgs...) {
		t.FailNow()
	}
}
