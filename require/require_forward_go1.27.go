...
func (a *Assertions) ErrorAsType[E error](err error, msgAndArgs ...any) E {
...
func (a *Assertions) ErrorAsTypef[E error](err error, msg string, args ...any) E {
	if h, ok := a.t.(tHelper); ok {
		h.Helper()
	}
...
func (a *Assertions) NotErrorAsType[E error](err error, msgAndArgs ...any) {
	if h, ok := a.t.(tHelper); ok {
		h.Helper()
	}
	NotErrorAsType[E](a.t, err, msgAndArgs...)
}

// NotErrorAsTypef asserts that no error in err's tree matches type E.
func (a *Assertions) NotErrorAsTypef[E error](err error, msg string, args ...any) {
	if h, ok := a.t.(tHelper); ok {
		h.Helper()
	}
	NotErrorAsTypef[E](a.t, err, msg, args...)
}
