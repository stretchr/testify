...
func (a *Assertions) InDeltaMap(expected interface{}, actual interface{}, delta float64, msgAndArgs ...interface{}) bool {
	return InDeltaMap(a.t, expected, actual, delta, msgAndArgs...)
}

// InDeltaMapf asserts key equality and value delta equality on two maps.
func (a *Assertions) InDeltaMapf(expected interface{}, actual interface{}, delta float64, msg string, args ...interface{}) bool {
	return InDeltaMapf(a.t, expected, actual, delta, msg, args...)
}
