...
func Test_isEmpty(t *testing.T) {
	...
	assert.True(isEmpty([]string{}))
	assert.True(isEmpty(0))
	assert.True(isEmpty(false))
	assert.True(isEmpty(map[string]string{}))

	assert.False(isEmpty("something"))
	assert.False(isEmpty(errors.New("something")))
	assert.False(isEmpty([]string{"something"}))
	assert.False(isEmpty(1))
	assert.False(isEmpty(true))
	assert.False(isEmpty(map[string]string{"Hello": "World"}))
