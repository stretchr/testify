...
// that will be invoked at runtime, letting you dynamically return different values.
//
//	Mock.On("HelloWorld").Return(func(args mock.Arguments) mock.Arguments {
//		return Arguments{"Hello " + arg[0].(string)}
//	})
